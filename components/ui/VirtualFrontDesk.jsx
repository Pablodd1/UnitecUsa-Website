        ...
        <div className="fixed bottom-6 right-6 z-[9998] flex flex-col items-end">
            ...
            {!isOpen && (
                <button 
                    ...
                    className="mb-2 bg-gray-200 text-gray-600 hover:bg-gray-300 rounded-full p-1 shadow-md transition-colors"
            ...
            <motion.button
                ...
                className="relative flex items-center justify-center w-16 h-16 bg-gradient-to-r from-primary to-secondary text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300"
