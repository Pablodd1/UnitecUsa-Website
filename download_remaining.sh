...
mkdir -p "downloads/technical_sheets"

# Function to extract file ID from Google Drive URL
get_file_id() {
    echo "$1" | grep -oP '/file/d/\K[a-zA-Z0-9_-]+'
}
...
# Files already downloaded (skip these)
skip_files=(
    "01_FT_Piso_Deck"
    "02_FT_Piso_SPC"
    "03_FT_Lamina_Marmol_PVC"
    "04_FT_Pared_PU_ArqUnitec"
    "05_FT_Paredes_Muroflex"
    "06_FT_Pared_Uniflex"
    "07.1_FT_Pared_acolchada_PalmaTrigo"
    "07.2_FT_Pared_Acolchada_Aurora"
    "08_FT_Panel_PS_Interior"
    "09_FT_Fachada_Deck"
    "10_FT_Polifachada"
)
...
mkdir -p "downloads/technical_sheets/LAMINAS"
mkdir -p "downloads/technical_sheets/PANELES WPC"
mkdir -p "downloads/technical_sheets/PAREDES"
mkdir -p "downloads/technical_sheets/CIELO RASO PVC"
mkdir -p "downloads/technical_sheets/CINTAS ADHESIVAS"
mkdir -p "downloads/technical_sheets/CUBIERTAS"
mkdir -p "downloads/technical_sheets/ILUMINACIÓN"
mkdir -p "downloads/technical_sheets/JARDINES ARTIFICIALES"
mkdir -p "downloads/technical_sheets/LISTONES"
mkdir -p "downloads/technical_sheets/PEGANTES"
mkdir -p "downloads/technical_sheets/ZOCALOS"
